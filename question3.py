...
if(userName.lower() == "alex" and userPassword == "CSF434!"):
    print("Welcome to facebook!")
else:
    print("Wrong credentials, try again!")


#Notice the normalization of input with the .lower() method.
#This method will take whatever string is provided to it,
#and make it all lowercase. So, if I were to run the command HELLO.lower()
#the output would be `hello` in all lowercase characters
